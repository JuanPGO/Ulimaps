    ...
    return (
        ...
        <div id="sd">
            <div className='div-navegation-button'>
                <img  className="navegacion-button" src="./src/assets/img/botones/gps.png" alt="Escudo Unilibre"></img>
            </div>
            <div>
            ...
            <div>
                <img className="WelcomeImg"src="./src/assets/img/fotos/fotoBienvenida.jpg" alt="Foto Bienvenida" />
            </div>
        </div>
        </>
